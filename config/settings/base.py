...
ROOT_DIR = environ.Path(__file__) - 3  # (pm_compliance_service/config/settings/base.py - 3 = pm-compliance-service/)
APPS_DIR = ROOT_DIR.path('pm_compliance_service')
...
LOCAL_APPS = [
    'pm_compliance_service.compliance.apps.ComplianceConfig',
]
...
LOGGING = {
    ...
    'filters': {
        ...
        'ignore_check_url': {
            '()': 'pm_compliance_service.compliance.utils.IgnoreCheckUrl'
        }
    },
    'formatters': {
        'verbose': {
